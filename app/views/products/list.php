...
<div class="shop-header">
    ...
    <a href="/webbanhang/Product/add" class="btn-add-product">
        + Thêm sản phẩm
    </a>
</div>

<form method="GET" action="/webbanhang/Product" class="filter-form">
    <div class="filter-group">
        ...
        <a href="/webbanhang/Product" class="filter-reset">
            Bỏ lọc
        </a>
    </div>
</form>
    ...
    <?php if (!empty($products)): ?>
        ...
        <?php foreach ($products as $product): ?>
            ...
            <div class="shop-card">
                ...
                <a href="/webbanhang/Product/show/<?php echo $product->id; ?>" class="shop-image">
